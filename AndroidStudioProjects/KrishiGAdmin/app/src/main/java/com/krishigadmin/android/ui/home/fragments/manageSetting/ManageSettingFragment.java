package com.krishigadmin.android.ui.home.fragments.manageSetting;
...
import com.krishigadmin.android.databinding.FragmentManageSettingBinding;
...
@AndroidEntryPoint
public class ManageSettingFragment extends BaseFragment<FragmentManageSettingBinding> {
    ...
    protected void observeViewModel() {
        ...
        final Observer<User> getSubCategoryUserSuccess = new Observer<User>() {
            ...
            public void onChanged(User categories) {
                ...
                ArrayAdapter<String> adapter = new ArrayAdapter<String>(getContext(), android.R.layout.simple_dropdown_item_1line, gender);
